...
-- Each organization has its own database, and this table maps grouped_org_id to database credentials
...
COMMENT ON COLUMN "tenants".grouped_org_id IS 'Organization ID (primary key)';
